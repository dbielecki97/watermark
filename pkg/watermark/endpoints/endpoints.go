...
import (
	...
	"github.com/dbielecki97/watermark-service/internal"
	"github.com/dbielecki97/watermark-service/pkg/watermark"
...
type Set struct {
	...
	MustEmbedUnimplementedWatermarkServer endpoint.Endpoint
}
...
func NewEndpointSet(svc watermark.Service) Set {
	return Set{
		...
		MustEmbedUnimplementedWatermarkServer: UnimplementedEndpoint(),
	}
}
...
func UnimplementedEndpoint() endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
